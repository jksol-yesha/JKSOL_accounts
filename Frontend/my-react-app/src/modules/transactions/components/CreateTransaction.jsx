...
const CreateTransaction = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        contactId: '', // Will store the Party's ID
        notes: '',
        status: 1, // Default Posted
        currencyCode: transactionBranchCurrency,
        fxRate: '1',
        fromAccountId: '',
        toAccountId: '',
    ...
    const actualReferenceBranch = branches.find(b => Number(b.id) === referenceBranchId) || selectedBranchRecord || selectedBranch;
    ...
    useEffect(() => {
        ...
        if (contactChanged || branchStateChanged || branchGstRateChanged || becameTaxable) {
            ...
            let determinedType = 1; // Default fallback
            ...
            if (branchState && partyState) {
                determinedType = branchState === partyState ? 1 : 0;
            }
    ...
    return (
        <div className="transactions-create-page flex flex-col min-h-screen relative bg-gray-50/50">
            <PageHeader
            ...
            <div className="transactions-create-shell p-4 lg:p-6 max-w-3xl mx-auto w-full flex-1 min-h-0 flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-500">
                <form ref={formRef} noValidate onSubmit={handleSubmit} onKeyDown={handleFormKeyNavigation} className="transactions-create-form flex flex-col min-h-0 txn-desktop-form txn-laptop-form txn-mobile-form">
                    <Card className="flex flex-col h-full min-h-0 max-h-[calc(100dvh-130px)] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-none p-0 overflow-hidden txn-desktop-card txn-laptop-card txn-mobile-card">
                        <div className="flex flex-col h-full min-h-0 p-4 lg:p-6">
                            ...
                            <div className="pt-4 mt-2 border-t border-gray-100 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 sm:space-x-4">
                                <button
                                    type="button"
                                    onClick={() => navigate('/transactions')}
