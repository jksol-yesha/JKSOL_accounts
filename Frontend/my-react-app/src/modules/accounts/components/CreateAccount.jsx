    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const p = {
                ...
                branchId: 1 // Dummy ID as accounts are now global
            };
                    ...
                    <div className="bg-white rounded-[24px] shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100 p-6 md:p-10 space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <CustomSelect
                                        ...
                                        className="w-full px-4 py-2 bg-gray-50 border border-gray-50 rounded-xl text-[14px] font-bold text-slate-700 outline-none focus:border-black transition-all"
                                    >
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <CustomSelect
                                        ...
                                        className={`w-full px-4 py-2 bg-gray-50 border ${errors.accountType ? 'border-rose-500' : 'border-gray-50 focus:border-black'} rounded-xl text-[14px] font-bold text-slate-700 outline-none transition-all`}
                                    >
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <CustomSelect
                                        ...
                                        className={`w-full px-4 py-2 bg-gray-50 border ${errors.subtype ? 'border-rose-500' : 'border-gray-50 focus:border-black'} rounded-xl text-[14px] font-bold text-slate-700 outline-none transition-all disabled:opacity-50 disabled:bg-gray-100`}
                                    >
                        ...
                        {isAssetBank && (
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    />
                                    {detectedBank && (
                                        <p className="text-[10px] font-semibold text-emerald-600 mt-0.5 pl-1">
                                            Detected bank: {detectedBank.bankName}
                                        </p>
                                    )}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-[13px]">{formData.currencyCode}</span>
                                    <input
                                        type="text"
                                        inputMode="decimal"
                                        name="openingBalance"
                        ...
                        {/* 9. Active Toggle */}
                        <div className="flex items-center justify-start gap-2 p-0 bg-transparent border-0 rounded-none">
                            <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                />
                                <div className="w-10 h-5 bg-white border border-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[1px] after:left-[1px] after:bg-white after:border-white after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-black peer-checked:border-black"></div>
                            </label>
