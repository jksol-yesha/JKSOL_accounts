                                ...
                                <tr className="bg-gray-50/50 border-y border-gray-200">
                                    {(() => {
                                        const cols = [
                                            ...
                                            { label: 'Net Balance', key: 'oweAmount', width: 'w-[12%]', align: 'text-right' },
                                        ...
                                        return cols.map((col) => (
                                            <th
                                                ...
                                                className={cn(
                                                    ...
                                                    col.key === 'openingBalance' && "pr-3",
                                                    col.key === 'oweAmount' && "pl-3 pr-0"
                                                )}
                                        ...
                                        return (
                                            <React.Fragment key={account.id}>
                                                <tr className="group hover:bg-gray-50/50">
                                                    ...
                                                    <td className="px-4 py-1.5 pr-3 text-xs font-black tabular-nums text-right whitespace-nowrap">
                                                    ...
                                                    <td className="px-4 py-1.5 pl-4 pr-4 text-xs font-black tabular-nums text-right whitespace-nowrap">
                                                        {(() => {
