                ...
                />
                    ...
                    {!isDesktopView && (
                        <div className="relative flex-1 p-4 space-y-4 min-h-0" aria-busy={loading}>
                            {showInitialLoader ? (
                                <div className="text-center py-8 text-sm text-gray-500">Loading logs...</div>
                            ) : logs.length === 0 ? (
                    ...
                    {(isDesktopView || typeof window === 'undefined') && (
                        ...
                        <table className="w-full text-left border-collapse table-fixed">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {showInitialLoader ? (
                                    <tr>
                                        <td colSpan="6" className="px-6 py-8 text-center text-sm text-gray-500">Loading logs...</td>
                                    </tr>
                                ) : logs.length === 0 ? (
                                    <tr>
