...
const CategoryRegistry = ({
    ...
    return (
        <Card noPadding className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col bg-white category-laptop-registry-card w-full max-h-full min-h-0" onClick={closeDropdowns}>
            ...
            {/* Desktop Table View */}
            <div
                className="relative hidden lg:block print:hidden flex-1 min-h-0 overflow-x-auto overflow-y-auto no-scrollbar category-laptop-registry-scroll"
            ...
            >
                <table className="w-full text-left border-collapse min-w-[700px] category-laptop-registry-table">
                    ...
                    {showInitialLoader ? (
                        <tbody>
                            <tr>
                                <td colSpan={showBranchColumn ? 6 : 5} className="px-6 py-20">
            ...
            <div className="hidden lg:flex items-center justify-between px-3 py-1 border-t border-gray-100 flex-none bg-white relative z-20 gap-2 print:hidden category-laptop-registry-footer">
                <div className="text-[9px] text-gray-500 font-medium text-center sm:text-left leading-tight">
                ...
                <div className="flex items-center space-x-2">
                    <button
                        ...
                        className="px-2 py-0 text-[9px] font-bold text-gray-500 hover:text-gray-700 disabled:opacity-30 disabled:hover:text-gray-500 transition-colors h-5"
                    >
                        Previous
                    </button>
                    ...
                    <div className="flex items-center space-x-1">
                        {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                            <button
                                ...
                                className={cn(
                                    "w-5 h-5 flex items-center justify-center rounded-md text-[9px] font-bold transition-all",
                                    page === currentPage
