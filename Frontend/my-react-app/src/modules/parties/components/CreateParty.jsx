...
const CreateParty = () => {
    ...
    return (
        <div className="parties-create-page flex flex-col min-h-screen bg-gray-50/50">
            <PageHeader
            ...
            <div className="parties-create-shell p-4 lg:p-8 max-w-2xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                <form onSubmit={handleSubmit} className="parties-create-form">
                    <div className="parties-create-card bg-white rounded-[24px] shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100 p-6 md:p-10 space-y-4">
