...
const CustomSelect = React.forwardRef(({
    ...
    const updatePosition = React.useCallback(() => {
        if (buttonRef.current) {
            ...
            // Account for very bottom of screen
        ...
        <div className="relative" ref={wrapperRef}>
            ...
            {isOpen && typeof document !== 'undefined' && createPortal(
                <div
                    ...
                    className="z-[9999] bg-white border border-gray-100 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200"
                >
                    <div className="max-h-[50vh] lg:max-h-64 overflow-y-auto no-scrollbar p-1.5">
                        {options.map((option) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        "w-full rounded-lg px-3 py-2.5 text-sm text-left transition-colors flex items-center justify-between",
                                ...
                                >
                                    <span className="block w-full pr-1 whitespace-normal break-all leading-snug">{option.label}</span>
                                </button>
                            );
                        })}
                    </div>
