                            ...
                            <>
                                ...
                                >
                                    <div className="px-3 py-1.5 border-b border-gray-50 bg-gray-50/50 flex items-center justify-between">
                                        ...
                                        {(['owner'].includes(user?.role?.toLowerCase()) || selectedOrg?.role?.toLowerCase() === 'owner') && (
                                            <button
                                                onClick={() => {
                                                    setIsOpen(false);
                                                    setShowManageModal(true);
                                                }}
                                                className="p-1.5 hover:bg-gray-200 rounded-lg text-gray-700 hover:text-black transition-colors"
                                            >
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2">
                                                        <p className={`text-sm font-medium truncate ${isStaged && !isInactive ? 'text-gray-900' : 'text-gray-600'}`}>
                                                            {branch.name}
                                                        </p>
                                                        {isInactive && (
                                                    ...
                                                    <div className="flex items-center gap-2 text-xs text-gray-400 mt-0.5">
                                                        <span className="truncate max-w-[80px] font-medium text-gray-400">{branch.currencyCode || branch.code}</span>
