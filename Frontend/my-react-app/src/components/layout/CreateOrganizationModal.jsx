...
const CreateOrganizationModal = ({ isOpen, onClose, initialMode = 'list' }) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl relative z-10 animate-in zoom-in-95 duration-200 overflow-hidden flex flex-col max-h-[90vh]">
                                    ...
                                    {orgsArray.map(org => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3 overflow-hidden">
                                                {org.logo ? (
                                                    <img src={org.logo} alt="" className="w-9 h-9 rounded-lg object-cover bg-gray-100 border border-gray-200" />
                                                ) : (
                                                ...
                                                <div className="min-w-0">
                                                    <div className={`text-sm font-bold ${selectedOrg?.id === org.id ? 'text-black' : 'text-gray-700'}`}>
                                                        {org.name}
                                                    </div>
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                                    ...
                                    <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex gap-3 rounded-b-2xl mt-auto">
                                        ...
                                        >
                                            ...
                                            <span>{editingId ? 'Update Org' : 'Create Org'}</span>
                                        </button>
                                    </div>
                                </form>
                            ) : (
                                                        ...
                                                        >
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div className="flex flex-col">
                                                                    ...
                                                                    <span className="text-[10px] text-gray-400 font-medium">{branch.code}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    );
