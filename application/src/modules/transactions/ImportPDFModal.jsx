...
const ImportPDFModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleUpload = async () => {
        ...
        if (!selectedAccount) {
            setError('Please select an account or use auto-detect.');
            return;
        }
        ...
        try {
            ...
            console.log('PDF Import Success Response:', response);
            ...
            console.log("PDF Import Error Response Data:", err.response?.data);
