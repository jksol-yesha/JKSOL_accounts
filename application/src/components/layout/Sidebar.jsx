                ...
                <div className="flex-none px-3 pb-3 flex flex-col gap-0.5">
                    <div className="relative" ref={logoutConfirmRef}>
                        ...
                        >
                            ...
                            {!effectiveCollapsed && (
                                <>
                                    ...
                                    <LogOut size={15} strokeWidth={2} className={cn(
                                        "shrink-0 transition-colors group-hover:text-red-500",
                                        showLogoutConfirm ? "text-red-500" : "text-slate-500"
                                    )} />
                                </>
                            )}
                            {effectiveCollapsed && (
                        ...
                        {showLogoutConfirm && !effectiveCollapsed && (
                            <div className="mt-2 animate-in fade-in slide-in-from-top-2 duration-200 p-2 bg-white rounded-lg border border-slate-200 shadow-sm relative z-50">
                                <p className="text-[12px] font-bold tracking-tight text-slate-800 text-center mb-2">
                                    Log out?
                                </p>
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 rounded border border-slate-200 bg-white px-2 py-1 text-[11px] font-bold text-slate-600 transition-colors hover:bg-slate-50"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        ...
                                        disabled={isSaving}
                                        className="flex-1 rounded bg-rose-50 px-2 py-1 text-[11px] font-bold text-rose-600 transition-colors hover:bg-rose-100 disabled:opacity-60"
                                    >
                        ...
                        {showLogoutConfirm && effectiveCollapsed && (
                            <div className="absolute bottom-10 left-full ml-1 w-40 animate-in fade-in slide-in-from-left-2 duration-200 p-2 bg-white rounded-lg border border-slate-200 shadow-[0_10px_30px_rgba(0,0,0,0.08)] z-50">
                                <p className="text-[12px] font-bold tracking-tight text-slate-800 text-center mb-2">
                                    Log out?
                                </p>
                                <div className="flex gap-2">
                    ...
                    <NavLink
                        to="/settings"
                        onClick={(event) => handleSidebarItemActivate(event, '/settings')}
                        onKeyDown={(event) => handleSidebarItemKeyDown(event, '/settings')}
                        data-sidebar-focusable="true"
                        className={() => {
