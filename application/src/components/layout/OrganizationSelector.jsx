...
const OrganizationSelector = ({ isCollapsed, onTriggerKeyDown, buttonProps = {} }) => {
    ...
    return (
        <div
            className={`w-full flex items-center ${isCollapsed ? 'justify-center px-0' : 'gap-3 px-2.5'} py-2.5 rounded-lg border border-transparent transition-all duration-200 group relative cursor-default`}
        >
